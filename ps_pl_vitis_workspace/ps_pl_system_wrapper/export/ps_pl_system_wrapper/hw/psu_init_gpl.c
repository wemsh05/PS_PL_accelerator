...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFE07FU ,0x50000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFE07FU, 0x50000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B02442U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B02442U);
/*##################################################################### */
...
unsigned long psu_peripherals_init_data(void)
{
    ...
    */
	PSU_Mask_Write(CRF_APB_RST_FPD_TOP_OFFSET, 0x000F007CU, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_1_DIRECTION_1                                 0x820

    * Direction mode (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00000820U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x03FFFFFFU, 0x00000820U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_1_OP_ENABLE_1                                  0x820

    * Output enable (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00000820U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x03FFFFFFU, 0x00000820U);
/*##################################################################### */
