...
set psu_mio_init_data {
    ...
    mask_write 0XFF180080 0x000000FE 0x00000020
    ...
    mask_write 0XFF180084 0x000000FE 0x00000020
    ...
    mask_write 0XFF180098 0x000000FE 0x00000020
    ...
    mask_write 0XFF18009C 0x000000FE 0x00000020
    ...
    mask_write 0XFF180204 0xFFFFE07F 0x50000000
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02442
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000820
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000820
