...
--               c:/PS_PL_accelerator/PS_PL_accelerator.srcs/sources_1/bd/ps_pl_system/ip/ps_pl_system_clk_wiz_0_0/ps_pl_system_clk_wiz_0_0_sim_netlist.vhdl
...
entity ps_pl_system_clk_wiz_0_0_ps_pl_system_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of ps_pl_system_clk_wiz_0_0_ps_pl_system_clk_wiz_0_0_clk_wiz : entity is "ps_pl_system_clk_wiz_0_0_clk_wiz";
end ps_pl_system_clk_wiz_0_0_ps_pl_system_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of ps_pl_system_clk_wiz_0_0_ps_pl_system_clk_wiz_0_0_clk_wiz is
  signal clk_in1_ps_pl_system_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_ps_pl_system_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_ps_pl_system_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_ps_pl_system_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_ps_pl_system_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_ps_pl_system_clk_wiz_0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_ps_pl_system_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_ps_pl_system_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_ps_pl_system_clk_wiz_0_0,
...
entity ps_pl_system_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of ps_pl_system_clk_wiz_0_0 : entity is true;
end ps_pl_system_clk_wiz_0_0;

architecture STRUCTURE of ps_pl_system_clk_wiz_0_0 is
begin
inst: entity work.ps_pl_system_clk_wiz_0_0_ps_pl_system_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
