...
-- Date        : Wed Aug  5 22:47:08 2026
-- Host        : DESKTOP-PB1BCUE running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top ps_pl_system_axi_smc_0 -prefix
--               ps_pl_system_axi_smc_0_ ps_pl_system_axi_smc_0_stub.vhdl
-- Design      : ps_pl_system_axi_smc_0
...
entity ps_pl_system_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
...
end ps_pl_system_axi_smc_0;

architecture stub of ps_pl_system_axi_smc_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_a5ca,Vivado 2020.1";
begin
end;
